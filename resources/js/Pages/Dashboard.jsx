            ...
            <tbody>
              ...
              <tr className="border-b hover:bg-slate-50">
                ...
                <td className="py-3 px-4 text-emerald-700 font-semibold">
                  {formatINR(Number(businessSummary.left ?? 0))}
                </td>
              ...
              {/* Today's first half */}
              <tr className="border-b hover:bg-slate-50">
                <td className="py-3 px-4 font-medium text-slate-700">Today — First Half (12 AM - 12 PM)</td>
                <td className="py-3 px-4 text-emerald-700 font-semibold">
                  {formatINR(Number(timewiseSales.first_half?.left ?? 0))}
                </td>
                <td className="py-3 px-4 text-blue-700 font-semibold">
                  {formatINR(Number(timewiseSales.first_half?.right ?? 0))}
                </td>
                <td className="py-3 px-4 font-semibold">
                  {formatINR(
                    Number(timewiseSales.first_half?.left ?? 0) + Number(timewiseSales.first_half?.right ?? 0)
                  )}
                </td>
              </tr>
              ...
              <tr className="hover:bg-slate-50">
                <td className="py-3 px-4 font-medium text-slate-700">Today — Second Half (12 PM - 12 AM)</td>
                <td className="py-3 px-4 text-emerald-700 font-semibold">
                  {formatINR(Number(timewiseSales.second_half?.left ?? 0))}
                </td>
                <td className="py-3 px-4 text-blue-700 font-semibold">
                  {formatINR(Number(timewiseSales.second_half?.right ?? 0))}
                </td>
                <td className="py-3 px-4 font-semibold">
                  {formatINR(
                    Number(timewiseSales.second_half?.left ?? 0) + Number(timewiseSales.second_half?.right ?? 0)
                  )}
                </td>
              </tr>
              ...
              <tr className="bg-slate-50">
                <td className="py-3 px-4 font-medium text-slate-700">Today — Total</td>
                <td className="py-3 px-4 text-emerald-700 font-semibold">
                  {formatINR(
