...
function RewardPlan({ plans = [], businessSummary = {}, fristsell = null }) {
  ...
  const { placement_combined } = usePage().props;
  const matchedValue = placement_combined?.matched ?? 0;
      ...
      <div className="p-4">
        ...
        <div className="mb-6">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between mb-2 gap-1">
            ...
            <div className="text-sm font-medium text-slate-600">{formatINR(matchedValue)}</div>
          </div>
